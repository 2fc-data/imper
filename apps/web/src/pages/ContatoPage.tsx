...
export default function ContatoPage() {
  ...
  return (
    <section id="contato" className="mx-auto max-w-5xl px-4 my-16 sm:my-24">
      <m.div
        ref={cardRef}
        initial="hidden"
      ...
      >
        <div className="p-6 sm:p-10">
          <h2 className="text-2xl font-bold tracking-tight sm:text-3xl">
            Fale com a Imperpoços
          </h2>
          <p className="mt-2 max-w-2xl text-sm leading-relaxed text-primary-foreground/80 sm:text-base">
            Solicite uma visita técnica, um orçamento ou orientação sobre o
            melhor sistema impermeabilizante para a sua obra.
          </p>
