        ...
        >
          {itens.map((item, i) => (
            <NavLink
              ...
              className={({ isActive }) =>
                cn(
                  "-ml-2 flex items-center gap-1.5 rounded-lg border border-transparent px-3 py-1.5 text-sm font-medium text-muted-foreground transition-colors hover:bg-accent/50 hover:text-accent-foreground",
                  isActive &&
